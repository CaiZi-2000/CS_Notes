...
计算机中所有信息都是采用二进制数来表示的。一个最小的可寻址内存单元可以存储的值的范围是 $$(00 00 00 00){2}$$ _到_  $$(11 11 11 11){2}$$ ，即十进制的 `0` 到 `255` 共 `256` 种取值。但为了表示方便，我们通常采用 **十六进制(hexadecimal)表示法** 表示，即 $$(00){16}$$ _到_ $$(FF){16}$$ 。
...
__$$i = 0 \rightarrow (1){16}$$ _后面补上_ $$j$$ _个_ $$(0){16}$$&#x20;

$$i = 1 \rightarrow (2){16}$$ _后面补上_  $$j$$ _个_ $$(0){16}$$__

__$$i = 2 \rightarrow (4){16}$$ _后面补上_  $$j$$ _个_ $$(0){16}$$__

__$$i = 3 \rightarrow (8){16}$$ _后面补上_  $$j$$ _个_ $$(0){16}$$__
